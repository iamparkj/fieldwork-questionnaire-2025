...
\begin{enumerate}[noitemsep]
  ...
  \begin{itemize}[noitemsep]
    \item 어휘의미론 파악을 위한 어휘: 의도한 의미 맥락에서 검출된 이후에는 표준어형이나 예상되었던 방언형에서 연관된 어휘를 제시하여 해당 단어는 쓰지 않는지, 쓴다면 그 의미 분포가 어떻게 다른지 등을 직접적으로 질문할 수 있다. 가령 /부엌/을 의도한 질문에서 /정지/ 등 다른 계통의 어휘가 검출될 경우, /부엌/이라는 단어는 쓰지 않는지, /정지/와 /부엌/의 차이는 무엇인지 등을 질문할 수 있다. 일부 어휘는 정확한 대상 지칭을 위해 4장의 <사진 자료>를 활용할 수도 있다.
