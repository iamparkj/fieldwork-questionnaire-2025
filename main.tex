...
\subsection{일러두기}
\begin{enumerate}[noitemsep]
  \item `자유발화 질문'은 특정 주제에 관한 질문을 던짐으로써, 자료제공인이 해당 주제에 관한 이야기로 자유롭게 답할 수 있도록 유도하는 질문이다. 해당 문답을 통해 등장한 어휘를 중심으로, 의미지도를 따라 다양한 어휘를 검출하기 위한 여러 질문을 이어나갈 수 있다. 이때, 자료제공인의 말을 끊거나 조급한 태도를 취하지 않도록 주의하며, 하나의 어휘가 적어도 두세 번 이상 관찰될 수 있도록 심화 질문을 활용할 수도 있다.
  \item 자료제공인이 질문의 내용을 이해하기 어려워할 수 있으므로, 비언어적 수단을 적극적으로 활용한다. 동작이나 도구를 나타내는 어휘라면 신체 동작을 활용하고, 사물을 나타내거나 상황을 묘사하는 어휘라면 Ⅳ장의 <사진 자료>를 활용한다. 사진 자료를 사용할 때는 자료제공인이 혼동하지 않고 정확히 이해할 수 있도록, 한 번에 하나의 사진만 보이도록 제시한다.
\end{enumerate} 
